      ...
      body: Consumer<CartController>(builder: (_, cartController, __) {
        if (cartController.cartList.isEmpty) {
          return SingleChildScrollView(
            child: Center(
              child: Column(
                children: [
                  SvgPicture.asset(AssetsPaths.emptyCart,fit: BoxFit.contain,),
                  Text(AppStrings.emptyCartText,style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                    fontSize: 15
                  ),),
                ],
              ),
        ...
        return Column(
          ...
          children: [
            ...
            CartScreenBottomLayout(size: size, cartController: cartController,),
          ],
        );
      }),
    );
