...
import 'package:fclp_app/screens/delivery_confirmation_screen/delivery_confirmation_finish.dart';
import 'package:fclp_app/screens/delivery_confirmation_screen/delivery_detail_form.dart';
import 'package:fclp_app/screens/delivery_confirmation_screen/delivery_payment_form.dart';
...
class DeliveryConfirmationView extends StatefulWidget {
  ...
  @override
  State<DeliveryConfirmationView> createState() =>
      _DeliveryConfirmationViewState();
}
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
              ...
              steps: [
                EasyStep(
                  customStep: CircleAvatar(
                    ...
                    child: (orderController.activeStep == 0)
                ...
                EasyStep(
                    customStep: CircleAvatar(
                      radius: 22,
                      backgroundColor: Colors.white,
                      child: (orderController.activeStep == 1 ||
                              orderController.activeStep == 0)
                          ? Icon(
                              Icons.monetization_on_rounded,
                              color: (orderController.activeStep == 1)
                ...
                EasyStep(
                    customStep: CircleAvatar(
                      ...
                      child: Icon(
                        Icons.verified,
                        size: 35,
                        color: (orderController.activeStep == 2)
                            ? AppColors.themeColor
                            : Colors.grey,
                      ),
                    ),
          ...
          Expanded(
            child: Consumer<OrderController>(builder: (_, orderController, __) {
